...
**Исправлено:**
- Версия обновлена с v1.6 до актуальной v1.7
...
**Версия:** 1.7 | **Платформы:** Windows, Linux, macOS
...
- **Настройки уведомлений админа** — вкл/выкл уведомления об ошибках и сводки о завершении парсинга
- **Батчинг запросов** — детали товаров загружаются батчами по 50 UUID для надёжности
...
user_settings         -- персональные настройки подписчика
  ...
  notify_errors INTEGER       -- уведомления об ошибках (для админа)
  notify_parse_finish INTEGER -- сводка о завершении парсинга (для админа)
